    ...
    event.create('ad_astra:tier_2_rocket')
        ...
        .scene('kubejs:rocket_2_body', 'kubejs:rocket_2_body', 'kubejs:rocket_2', scene => {
            ...
            for (let dy of [2, 3, 4, 5, 6]) {
                ...
                for (let i = 0; i < 4; i++) {
                    scene.world.setBlocks(zuobiao[i], 'ad_astra:desh_block', false)
            ...
            let zuobiao_2 = [[4, 8, 4], [4, 8, 5], [4, 8, 6], [5, 8, 6], [6, 8, 6], [6, 8, 5], [6, 8, 4], [5, 8, 4]]
            ...
            for (let i = 0; i < 8; i++) {
                if (i % 2 == 0) {
                    ...
                    scene.world.setBlocks(zuobiao_2[i], 'ad_astra:desh_plating_stairs', false)
                }
                if (Math.floor(i / 2) == 0) {
                    scene.world.modifyBlock(zuobiao_2[i], state =>
                        state.with('facing', 'east'), false)
...
//
        .scene('kubejs:rocket_2_whole', 'kubejs:rocket_2_whole', 'kubejs:rocket_2', scene => {
            ...
            for (let dy of [5, 6, 7, 8, 9]) {
                ...
                let zuobiao = [[4, dy, 5], [6, dy, 5], [5, dy, 6], [5, dy, 4]]
                for (let i = 0; i < 4; i++) {
                    if (zuobiao[i] == [5, 6, 4] || zuobiao[i] == [5, 7, 4]) {
                        scene.world.setBlocks(zuobiao[i], 'createnuclear:reinforced_glass', false)
                    } else {
                        scene.world.setBlocks(zuobiao[i], 'ad_astra:desh_block', false)
                    }
                    scene.world.showSection(zuobiao[i], Direction.DOWN)
            ...
            let zuobiao_2 = [[4, 11, 4], [4, 11, 5], [4, 11, 6], [5, 11, 6], [6, 11, 6], [6, 11, 5], [6, 11, 4], [5, 11, 4]]
