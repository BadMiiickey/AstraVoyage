                ...
                server.players.forEach(/** @param { Internal.Player } player */player => {
                    if (player.level.dimension == rocket_2.dimension) {
                        ...
                        if (block.id == 'kubejs:desh_tank') {
                            ...
                            rocket_2.pillarResult = pillarResult
                            rocket_2.slabResult = slabResult
                            rocket_2.deshSlabResult = deshSlabResult
                            rocket_2.stairsResult = stairsResult
                            rocket_2.deshStairsResult = deshStairsResult
                            rocket_2.blockResult = blockResult
                            rocket_2.glowingPillarResult = glowingPillarResult
                            rocket_2.deshBlockResult = deshBlockResult
                            rocket_2.glassResult = glassResult
                            rocket_2.platingResult = platingResult
                            rocket_2.lightningRodResult = lightningRodResult
