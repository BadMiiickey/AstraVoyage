ForgeModEvents.onEvent('net.minecraftforge.fml.event.lifecycle.FMLCommonSetupEvent', event => {
    ...
    let $FanProcessingTypeRegistry = Java.loadClass('com.simibubi.create.content.kinetics.fan.processing.FanProcessingTypeRegistry')
    ...
    let $Color = Java.loadClass('com.simibubi.create.foundation.utility.Color')
    ...
    const freezingTypeImplementation = {
        ...
        morphAirFlow(particleAccess, random) {
            ...
            particleAccess.setColor($Color.mixColors(11591910, 8562943, random.nextFloat()))
    ...
    $FanProcessingTypeRegistry.register($Create.asResource('freezing'), freezingType)
})